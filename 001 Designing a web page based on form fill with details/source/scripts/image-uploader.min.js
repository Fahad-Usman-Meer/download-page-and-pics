	...
	$.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id) {
			...
			$button.on("click", function (e) {
                ...
                if ($container.parent()[0].childElementCount == 1) {
                    allDeleted = true;
                }
		...
		let fileSelectHandler = function (e) {
            ...
            var inCorrectFiles = null;

            //debugger
            var addedCount = $container[0].children[1].childElementCount;

            if ((addedCount + files.length) > 10) {
            ...
            for (var i = 0; i < files.length; i++) {
                ...
                debugger
                var isValidType = $.inArray(type, acceptedImageTypes);

                if (isValidType < 0) {
                    if (inCorrectFiles == null) {
                        inCorrectFiles = "Incorrect Files Found: \n\n";
                    }
                    inCorrectFiles = inCorrectFiles + files[i].name + "\n";
                }
            }
